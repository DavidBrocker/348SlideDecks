...
- What percentage of Students rate it a 4 or lower?
...
> You scored an **82**. Is that good?

::: incremental
- You can't say yet — good *compared to what?*
- **Standard deviation** describes how spread out the whole group is — but only in the variable's own units (exam points, inches, dollars…).
- A **z-score** places *one* score on a common ruler: how many standard deviations it sits from the mean.
- Because that ruler has no units, it can answer "compared to what?" for *any* measurement.
:::
...
> Aisha's raw scores: **82** in Statistics, **70** in Research Methods. Which did she do better on?
...
::: fragment
Raw scores said Statistics (82 \> 70). The z-scores say **Research Methods** — above average there, below average in Stats. Same student, opposite story.
:::
...
- A z-score is **unitless** — it drops the original measurement entirely.
- So **z = +2 means the same thing** whether the score is in exam points, inches, or dollars: *two standard deviations above average.*
- That's what standard deviation *alone* can't give you — a way to compare scores measured on completely different scales.
...
- Subtract the \[mean\]{style="color:orange"} value from each \[x\]{style="color:red"}.
...
- $x = \mu + (z\times\sigma) = 40 + (2.5\times6) = 55$
...
$$s = \sqrt{\frac{\sum(x-\color{red}{\bar{x}})^2}{n-1}} = \sqrt{\frac{400}{4}} = \sqrt{100} = 10$$
:::
::::
...
$$z =\frac{x-\color{red}{\bar{x}}}{s} = \frac{10-20}{10} = \frac{-10}{10} = -1$$
:::
::::
:::::::::
...
## $$\color{red}{\bar{x}} = \frac{\sum{x}}{n} = \frac{100}{5} = 20$$
