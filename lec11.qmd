...
-   With independent samples, chance variation now includes **differences between individuals** in *both* groups.
...
$$\color{blue}{t} = \frac{\color{red}{\bar{x}_1} -\color{orange}{\bar{x}_2}}{\sqrt{\color{grey}{\sigma^{2}_{pooled}}}}$$

-   [t]{style="color:blue"} = T Statistic

-   [Sample Mean, Group 1]{style="color:red"}

-   [Sample Mean, Group 2]{style="color:orange"}

-   [Population Pooled Variance]{style="color:grey"}

## Independent samples t-test

Theoretical Formula:

$$t = \frac{\bar{x}_1 - \color{green}{\bar{x}_2}}{\sqrt{\sigma^{2}_{pooled}}}$$

## Independent samples t-test

### Theoretical Formula:

$$t = \frac{\bar{x}_1 - \bar{x}_2}{\sqrt{\color{orange}{\sigma^{2}_{pooled}}}}$$

## Independent samples t-test

### Theoretical Formula:

$$t = \frac{\bar{x}_1 - \bar{x}_2}{\sqrt{\sigma^{2}_{pooled}}}$$
...
$$\frac{\bar{x}_{Experimental}-\bar{x}_{Control}}{\sqrt{\color{darkblue}{\frac{s_1^2}{n_1}+ \frac{s_2^2}{n_2}}}}$$
...
$$\frac{\bar{x}_{Experimental}-\bar{x}_{Control}}{\sqrt{\frac{s_1^2}{n_1}+ \frac{s_2^2}{n_2}}}$$
