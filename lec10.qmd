...
-   **Formula**: $\large{t = \frac{\bar{d}}{s_d/\sqrt{n}}}$
...
> A psychologist measures stress levels of a group before and after a mindfulness program. Participants first answer a stress survey, next they participate in a mindfulness exercise. After the exercise, their stress scores are measured again and compared.
...
3.  $\large{t = \frac{\bar{d}}{{s_d}/\sqrt{n}} =  \frac{-3.26}{2.083/\sqrt{30}} = (-8.57)}$
...
-   CI\[ll,uu\] = 95% CI of Mean Difference ($\bar{d}$)
...
-   For a paired-samples design, this version of Cohen's *d* is written $d_z$ to keep it distinct from $\bar{d}$ (mean difference) and $s_d$ (SD of the differences):
...
-   The **effect size ($d_z$ = 1.56)** indicates a *large* change.\
