...
> SPSS (Statistical Package for the Social Sciences) is used in a variety of disciplines and has options for the majority of tests that you will end up running in your academic career. SPSS also has a syntax editor which allows you to have more control over your data/tests/outputs.
