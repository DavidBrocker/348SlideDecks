...
- $z = 1 \Rightarrow x = 25 + (1)(2) = 27$

- $z = -2 \Rightarrow x = 25 + (-2)(2) = 21$

- $z = 0.5 \Rightarrow x = 25 + (0.5)(2) = 26$
...
- If you need that z-score or higher, you have to subtract the decimal from 1.
  - Esmeralda had a `2.2`% chance of failing and a `1-.022 = 97.8%` chance of passing.
...
- Find -0.6 on the left side of the table (z column) — use the negative-z page

- Find .03 column

- Note where they intersect — since the table already gives "area to the left," this **is** the probability we want

- Report the value as a percentage (the proportion $\times 100$)
:::
:::::
...
- Find 1.1 on the left side of the table (z column)

- Find .08 column

- Note where they intersect

- Remember we are thinking about 8 or more, so we have to subtract that proportion from 1
...
- Find 2.0 on the left side of the table (z column)
