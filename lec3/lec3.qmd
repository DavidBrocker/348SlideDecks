...
::: icon-row-item
[event_seat]{.material-icons}

Moving a Chair
:::

::: icon-row-item
[attach_money]{.material-icons}
...
- Scale of Measurement: Ordinal -- a 1-10 self-esteem rating is a Likert-style scale, and (per the Ordinal slide earlier) Likert-style ratings are technically ordinal even though they're often treated as interval in practice. Good discussion point: ask the class why researchers commonly treat scales like this as interval anyway.
